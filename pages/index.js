  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        ...
        <meta name="description" content="Portfolio website of Dimitri Marco" />
      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between">
            <h1 className="text-xl font-burtons dark:text-white">DevelopedbyKaz</h1>
          ...
          <div className="text-center p-10">
            ...
            <p className=" text-md py-5 leading-8 text-gray-400 md:text-xl max-w-lg mx-auto">
              Freelancer providing services for programming and/or design needs.
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              Since the beginning of my journey as a freelance designer and web
